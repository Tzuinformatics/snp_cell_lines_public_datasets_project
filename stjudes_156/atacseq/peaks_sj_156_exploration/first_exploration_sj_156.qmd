...
pheatmap::pheatmap(
  ...
  border_color = NA,
  main = "ATAC module activity (ALL peaks; one peak/gene = closest-to-TSS; column-scaled)"
)
```
...
pheatmap::pheatmap(
    ...
    border_color = NA,
    main = paste0("ATAC module activity (PROMOTERS = |distanceToTSS| ≤ ",
...
pheatmap::pheatmap(
  ...
  border_color = NA,
  main = paste0("ATAC module activity (ENHANCERS = |distanceToTSS| > ",
...
pheatmap::pheatmap(
    ...
    border_color      = NA,
    main              = "ATAC module activity (Savics ALL markers; liftover + overlap; column-scaled; SINGLE-LABEL ONLY)"
)
...
pheatmap::pheatmap(
  ...
  border_color = NA,
  main = "ATAC module activity (Savics PROMOTERS only)"
)
...
pheatmap::pheatmap(
  ...
  border_color = NA,
  main = "ATAC module activity (Savics ENHANCERS only)"
)
...
### Confirming TRUE proB based on reads
